...
build-2130284401:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-2130284401-inproc

build-2130284401-inproc: ../app.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-2130284401 ../app.cfg
configPkg/compiler.opt: build-2130284401
configPkg/: build-2130284401
