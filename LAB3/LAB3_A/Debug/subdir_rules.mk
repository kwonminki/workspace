...
build-2128577665:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-2128577665-inproc

build-2128577665-inproc: ../app.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-2128577665 ../app.cfg
configPkg/compiler.opt: build-2128577665
configPkg/: build-2128577665

%.obj: ../%.c $(GEN_OPTS) | $(GEN_FILES)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C6000 Compiler'
	"C:/ti/ccs901/ccs/tools/compiler/ti-cgt-c6000_8.3.2/bin/cl6x" -mv6740 --include_path="D:/workspace_v9/LAB3_A" --include_path="C:/ti/bios_6_76_02_02/packages/ti/posix/ccs" --include_path="C:/ti/ccs901/ccs/tools/compiler/ti-cgt-c6000_8.3.2/include" --define=c6748 -g --c99 --diag_warning=225 --diag_wrap=off --display_error_number --preproc_with_compile --preproc_dependency="$(basename $(<F)).d_raw" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
