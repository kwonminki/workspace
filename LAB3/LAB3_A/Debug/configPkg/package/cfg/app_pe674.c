...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[6445];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/workspace_v9/LAB3_A/Debug/configPkg/package/cfg/app_pe674");
...
__FAR__ const CT__ti_sysbios_family_c64p_primus_TimerSupport_Module__id ti_sysbios_family_c64p_primus_TimerSupport_Module__id__C = (xdc_Bits16)0x8033;
...
__FAR__ const CT__ti_sysbios_rts_ti_ThreadLocalStorage_Module__id ti_sysbios_rts_ti_ThreadLocalStorage_Module__id__C = (xdc_Bits16)0x8026;
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x192d;
