...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[6462];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/workspace_v9/LAB5_A1/Debug/configPkg/package/cfg/app_pe674");
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x193e;
