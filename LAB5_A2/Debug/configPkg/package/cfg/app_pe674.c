...
/* --> ProcessClk */
extern xdc_Void ProcessClk(xdc_UArg);
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[6469];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/workspace_v9/LAB5_A2/Debug/configPkg/package/cfg/app_pe674");
...
ti_sysbios_knl_Clock_Object__ ti_sysbios_knl_Clock_Object__table__V[1] = {
    {/* instance#0 */
        ...
        1,  /* active */
        ((xdc_Void(*)(xdc_UArg))((xdc_Fxn)ProcessClk)),  /* fxn */
        ((xdc_UArg)0),  /* arg */
    },
};
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1945;
