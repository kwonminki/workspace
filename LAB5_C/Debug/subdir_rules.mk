...
build-2129716673:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-2129716673-inproc

build-2129716673-inproc: ../app.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-2129716673 ../app.cfg
configPkg/compiler.opt: build-2129716673
configPkg/: build-2129716673
