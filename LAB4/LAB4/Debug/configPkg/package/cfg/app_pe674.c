...
/* --> ProcessIdle */
extern xdc_Void ProcessIdle(xdc_Void);
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[6460];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/workspace_v9/LAB4/Debug/configPkg/package/cfg/app_pe674");
...
const __T1_ti_sysbios_knl_Idle_funcList ti_sysbios_knl_Idle_funcList__A[2] = {
    ((xdc_Void(*)(xdc_Void))((xdc_Fxn)ProcessIdle)),  /* [0] */
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x193c;
